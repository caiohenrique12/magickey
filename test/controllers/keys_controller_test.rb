...
class KeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create key" do
    assert_difference('Key.count') do
      post keys_url, params: { key: { local: @key.local, password: @key.password, user_id: @key.user_id } }
    end
  ...
  test "should update key" do
    patch key_url(@key), params: { key: { local: @key.local, password: @key.password, user_id: @key.user_id } }
